...
![Screen representation](/images/raytracing-scratch/screen_representation.png)
...
![How to compute an ray-sphere intersection](/images/raytracing-scratch/equation_line_intersect.png)
