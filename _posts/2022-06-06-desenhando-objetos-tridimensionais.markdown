...
🤔 se queremos calcular o ponto $$P'$$, podemos ver que o valor da sua coordenada $$y$$ é o segmento $$\overline{AP'}$$.Sabemos também que o valor da sua $$z$$coordenada é a mesma do plano $$proj$$.
