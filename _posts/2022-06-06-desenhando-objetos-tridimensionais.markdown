...
Uma camera funciona como o [experimento da câmara escura](https://pt.wikipedia.org/wiki/C%C3%A2mera_escura)[1]. Em que a "fotografia" ou o "video" é capturado dentro da câmera.
